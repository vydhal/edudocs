            ...
            <main className="flex-1 overflow-y-auto pb-10 w-full max-w-3xl mx-auto">
                <div className="px-4 pt-6">
                    ...
                    <p className="text-[#4a5568] dark:text-gray-400 text-sm font-normal leading-normal mt-2">
                        Preencha as informações abaixo para criar um novo acesso administrativo no sistema <span className="text-[var(--primary-color)] dark:text-[#5ab2d1] font-semibold">EduDocs</span>.
                    </p>
                </div>
                ...
                <form className="mt-6 space-y-6 px-4">
                    ...
                    <div className="bg-white dark:bg-[#1e2329] rounded-xl p-4 shadow-sm border border-gray-50 dark:border-gray-800">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="material-symbols-outlined text-[var(--primary-color)] dark:text-[#5ab2d1] text-xl">person</span>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col w-full">
                                ...
                                <input name="name" onChange={handleChange} value={formData.name} className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 placeholder:text-[#667d85] dark:placeholder:text-gray-600 px-4 text-base" placeholder="Ex: Maria Silva" type="text" />
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <input name="email" onChange={handleChange} value={formData.email} className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 placeholder:text-[#667d85] dark:placeholder:text-gray-600 px-4 text-base" placeholder="usuario@educacao.gov.br" type="email" />
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                <div className="flex flex-col">
                                    <p className="text-[#121617] dark:text-gray-200 text-sm font-medium pb-1.5 ml-1">Setor</p>
                                    <select className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 px-4 text-sm">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <input className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 placeholder:text-[#667d85] dark:placeholder:text-gray-600 px-4 text-sm" placeholder="Ex: Analista" type="text" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-[#1e2329] rounded-xl p-4 shadow-sm border border-gray-50 dark:border-gray-800">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="material-symbols-outlined text-[var(--primary-color)] dark:text-[#5ab2d1] text-xl">shield</span>
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-col">
                                ...
                                <div className="grid grid-cols-2 gap-2 bg-[#f6f7f8] dark:bg-[#121617] p-1 rounded-lg">
                                    <label className="cursor-pointer">
                                        ...
                                        <div className="flex items-center justify-center py-2 text-sm font-medium rounded-md transition-all peer-checked:bg-white dark:peer-checked:bg-[#2c333a] peer-checked:text-[var(--primary-color)] dark:peer-checked:text-[#5ab2d1] peer-checked:shadow-sm text-[#667d85] dark:text-gray-500">
                                            Editor
                                        </div>
                                    </label>
                                    <label className="cursor-pointer">
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <div className="relative">
                                    <input name="password" onChange={handleChange} value={formData.password} className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 px-4 pr-10 text-base" placeholder="••••••••" type="password" />
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <input name="confirmPassword" onChange={handleChange} value={formData.confirmPassword} className="flex w-full rounded-lg border border-[#dce2e4] dark:border-gray-700 bg-white dark:bg-[#121617] text-[#121617] dark:text-white focus:ring-2 focus:ring-[var(--primary-color)]/20 focus:border-[var(--primary-color)] h-12 px-4 text-base" placeholder="••••••••" type="password" />
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-8 px-6 text-center">
                    ...
                    <div className="mt-4 flex justify-center">
                        <div className="bg-[var(--primary-color)]/10 px-3 py-1 rounded-full">
                            <span className="text-[10px] font-bold text-[var(--primary-color)] dark:text-[#5ab2d1] uppercase tracking-widest">EduDocs Admin Portal</span>
                        </div>
                    </div>
                </div>
            </main>
